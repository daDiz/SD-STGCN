...
graph_name = gpath + '%s_N%s_g%s.edgelist' % (graph_type,N,graph_id)
...
sim_file = '%s_Rzero%s_gamma%s_ls%s_nf%s_N%s_g%s_entire.pickle' %\
            (sim_type,R0_k,gamma_k,len_seq,num_frames,N,graph_id)
