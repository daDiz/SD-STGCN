...
if sim_type == 'SIR':
    sim_file = '%s_Rzero%s_gamma%s_T%s_ls%s_nf%s_N%s_r%s_g%s_entire.pickle' %\
    (sim_type,R0,gamma,T,len_seq,num_frames,N,r,graph_id)
elif sim_type == 'SEIR':
    sim_file = '%s_Rzero%s_gamma%s_alpha%s_T%s_ls%s_nf%s_N%s_r%s_g%s_entire.pickle' %\
    (sim_type,R0,gamma,alpha,T,len_seq,num_frames,N,r,graph_id)
else:
