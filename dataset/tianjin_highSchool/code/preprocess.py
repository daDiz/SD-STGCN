...
if __name__ == '__main__':
    ...
    g = load_graph('../../highSchool/data/graph/highSchool.edgelist')
    ...
    nx.write_edgelist(g, '../data/graph/tianjin_highSchool.edgelist', data=False)

    with open('../data/SIR/tianjin_node_dict_highSchool.pickle', 'wb') as f:
        pickle.dump(node_dict, f)

    with open('../data/SIR/SIR_tianjin_highSchool.pickle', 'wb') as f:
